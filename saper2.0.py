...
IMG_BOMB = QImage("./images/mine.png")
IMG_FLAG = QImage("./images/flag.png")
IMG_START = QImage("./images/start.png")
IMG_CLOCK = QImage("./images/clock.png")

NUM_COLORS = {
    1: QColor('#0045f4'),  # blue
    2: QColor('#ff0074'),  # pink
    3: QColor('#f28500'),  # orange
    4: QColor('#420420'),  # purple
    5: QColor('#008020'),  # green
    6: QColor('#4d3c63'),  # an purple
    7: QColor('#e9e813'),  # yellow
    8: QColor('#0000ff')  # light blue
}
...
def music_start():
    ...
    if name == 'concorde':
        ...
        pygame.mixer.music.load('kicks.mp3')
        pygame.mixer.music.play()
...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.button.setIcon(QIcon("./images/norm.png"))
